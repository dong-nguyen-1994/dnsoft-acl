...
@section('title', __('acl::role.index.page_title'))
    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <div class="clearfix text-right">
          <x-button-create url="{{ route('admin.role.create') }}" />
          <x-button-reload url="{{ route('admin.role.index') }}" />
        </div>
      </div>
          ...
          <table class="table table-striped jambo_table bulk_action">
            ...
            <tbody>
              ...
              <tr class="{{ $key % 2 == 0 ? 'even' : 'odd' }} pointer">
                ...
                <td class="text-right">
                  @admincan('admin.role.edit')
                  <x-button-edit url="{{ route('admin.role.edit', $item->id) }}" title="Edit profile" icon="fa fa-pencil-square-o" />
                  @endadmincan

                  @admincan('admin.role.delete')
                  <x-button-delete url="{{ route('admin.role.destroy', $item->id) }}" />
                  @endadmincan
                </td>
